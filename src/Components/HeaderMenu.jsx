...
const HeaderMenu = () => {
    const { themes, currentTheme, textBoxPosition, contactInfo, setContactInfo, fontFamily } = useContext(PageContext);
    ...
    return (
        <div id="menuDiv" className={"w-full absolute top-0 h-16  flex   " + themeInUse.menuDiv + " " + textBoxPosition.headerMenu[menuPosition] + " " + fontFamily }>
